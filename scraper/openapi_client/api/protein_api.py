...
class ProteinApi:
    ...
    def create_protein(
        ...
        :param protein_entry: (required)
        :type protein_entry: ProteinEntry
        ...
        _param = self._create_protein_serialize(
    ...
    @validate_call
    def create_protein_with_http_info(
        self,
        protein_entry: ProteinEntry,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_protein_without_preload_content(
        self,
        protein_entry: ProteinEntry,
        _request_timeout: Union[
            None,
